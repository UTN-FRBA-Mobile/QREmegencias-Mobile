...
import com.qre.client.auth.HttpBasicAuth;
import com.qre.client.auth.ApiKeyAuth;
import com.qre.client.auth.OAuth;
import com.qre.client.auth.OAuth.AccessTokenListener;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "http://10.0.2.2:8082/qremergencias/";
    //String baseUrl = "http://172.16.21.139:8082/qremergencias/";
    if(!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
