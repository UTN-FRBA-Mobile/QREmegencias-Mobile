...
public class MedicalEmergencyDataFragment extends BaseFragment implements EmergencyDataAdapter.Listener {
    ...
    public void initialize() {
        ...
        EmergencyDataAdapter adapter = new EmergencyDataAdapter(getContext(), collection, true);
        adapter.setListener(MedicalEmergencyDataFragment.this);
